                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span
                                    className="flex-1 ml-3 text-left rtl:text-right whitespace-nowrap">Users</span>
                                <svg
                                    className="w-3 h-3"
                                    aria-hidden="true"
                        ...
                        <li>
                            <a href="/maintenance"
                               className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Project Status</span>
                            </a>
                        </li>
                        <li>
                            <a href="/maintenance"
                               className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Profile-Setting</span>
                            </a>
                        </li>
                    </ul>
                </div>
